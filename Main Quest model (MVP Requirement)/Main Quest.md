...
<div style="text-align: center;">
        ...
        <img src="./images/Model Result/Hasil analisis data anak.jpg" alt="Stunting and Wasting Results" style="width: 40%; max-width: 500px; height: auto;">
    </div>
...
<div style="text-align: center; margin-top: 20px;">
        ...
        <img src="./images/Model Result/Hasil analisis data ibu.jpg" alt="Maternal Health Risk Results" style="width: 40%; max-width: 500px; height: auto;">
    </div>
